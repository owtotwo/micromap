...
impl<K: PartialEq, V, const N: usize> Map<K, V, N> {
    ...
    #[inline]
    #[must_use]
    pub fn into_capacity<const M: usize>(mut self) -> Map<K, V, M> {
        assert!(
            self.len <= M,
...
mod tests {
    ...
    fn test_into() {
        ...
        let new_capacity_map: Map<i32, i32, 5> = map.into_capacity();
    ...
    fn test_into_panic() {
        ...
        let _small_map: Map<i32, i32, 2> = map.into_capacity();
    }
}
